  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'farms-fields-crops':
        return <FarmsFieldsCropsTab operationsData={operationsData} />;
      case 'plantings':
        return <PlantingsTab operationsData={operationsData} />;
      case 'harvests':
      ...
      case 'irrigation':
        return <IrrigationTab operationsData={operationsData} />;
      case 'tasks':
        return <TasksTab operationsData={operationsData} />;
      case 'ipm':
        return <IPMTab operationsData={operationsData} />;
      case 'batch-operations':
        return <BatchOperationsTab operationsData={operationsData} />;
      default:
        return <FarmsFieldsCropsTab operationsData={operationsData} />;
    }
  };
