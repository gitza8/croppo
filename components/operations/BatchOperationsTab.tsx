...
interface BatchOperationsTabProps {
  operationsData: any;
}

export default function BatchOperationsTab({ operationsData }: BatchOperationsTabProps) {
  ...
  const { batchOperations, fields, addBatchOperation, updateBatchOperation, deleteBatchOperation } = operationsData;
