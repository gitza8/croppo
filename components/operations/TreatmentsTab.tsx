...
export default function TreatmentsTab({ operationsData }: TreatmentsTabProps) {
  ...
  const { treatments, fields, crops, addTreatment, updateTreatment, deleteTreatment } = operationsData;
