...
interface PlantingsTabProps {
  operationsData: any;
}

export default function PlantingsTab({ operationsData }: PlantingsTabProps) {
  ...
  const { plantings, fields, crops, addPlanting, updatePlanting, deletePlanting } = operationsData;
